...
| Installed offline application | 0.4.0 deployed and installed | 140 tests, check/build, scoped code review, nine-state dual visual approval, native installation and disconnected local/public editing pass. See the 0.4.0 release record. |
...
0.4.0 completed: `b0ebb03173503c344104485f789f548242591d65` adds native installation metadata/icons and offline preparation states, followed by tag `v0.4.0` and successful Pages run 34705076008. Code review, 140 tests and both visual passes approve the exact source. Computer Use verified native local/public installation, installed local app operation with its server stopped, and public-tab reload/native autosave under an isolated Offline condition. The public installed app is left available; the temporary local installation was removed. [Release evidence](releases/0.4.0.md) records the tested surfaces and capability limits.
